...
.dlls,em3 .dlls: clock.pem3

-include package/cfg/clock_pem3.mak
-include package/cfg/clock_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/clock_pem3.dep
endif
clock.pem3: package/cfg/clock_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
clock.pem3 package/cfg/clock_pem3.c: .libraries,em3
endif

package/cfg/clock_pem3.c package/cfg/clock_pem3.h package/cfg/clock_pem3.xdl: override _PROG_NAME := clock.xem3
package/cfg/clock_pem3.c: package/cfg/clock_pem3.cfg
package/cfg/clock_pem3.xdc.inc: package/cfg/clock_pem3.xdl
package/cfg/clock_pem3.xdl package/cfg/clock_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/clock_pem3.cfg
	-$(RM) package/cfg/clock_pem3.dep
	-$(RM) package/cfg/clock_pem3.c
	-$(RM) package/cfg/clock_pem3.xdc.inc

clean,em3::
	-$(RM) clock.pem3
.executables,em3 .executables: clock.xem3

clock.xem3: |clock.pem3

-include package/cfg/clock.xem3.mak
clock.xem3: package/cfg/clock_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/clock_pem3.oem3   package/cfg/clock_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
clock.xem3: export C_DIR=
clock.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
clock.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

clock.test test,em3 test: clock.xem3.test

clock.xem3.test:: clock.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 clock.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.clock.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,clock.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
clock_pem3.oem3,copy : package/cfg/clock_pem3.oem3
clock_pem3.sem3,copy : package/cfg/clock_pem3.sem3
